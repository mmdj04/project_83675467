    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm dark:bg-neutral-950/90">
      <div className="flex h-14 items-center justify-between gap-6 px-4">
        ...
        <nav className="flex items-center gap-4">
          <Search />
          <a
            href="https://github.com/mmdj04/project_83675467"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-neutral-500 text-sm transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100"
          >
