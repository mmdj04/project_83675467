...
import { createRecentLeadsColumns } from "./columns";
...
const COLUMN_LABELS: Record<string, string> = {
  ...
  status: "columnStatus",
  source: "columnSource",
  lastActivity: "columnLastActivity",
};
...
export function RecentLeadsTable({ data }: { data: RecentLeadRow[] }) {
  ...
  const table = useTable({
    ...
    data,
    columns: React.useMemo(() => createRecentLeadsColumns(t), [t]),
    state: {
      rowSelection,
      columnVisibility,
      columnFilters,
                ...
                <DropdownMenuGroup>
                  {table
                    ...
                    .map((column) => (
                      ...
                      >
                        {COLUMN_LABELS[column.id] ? t(COLUMN_LABELS[column.id]) : column.id}
                      </DropdownMenuCheckboxItem>
                    ))}
                </DropdownMenuGroup>
              </DropdownMenuContent>
