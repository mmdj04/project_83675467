...
export function DriversForecastTarget() {
  ...
  return (
    <Card className="shadow-xs">
      <CardHeader>
        <CardTitle>{t("titleForecast")}</CardTitle>
        <CardDescription>{t("descriptionForecast")}</CardDescription>
      </CardHeader>
